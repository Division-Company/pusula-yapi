...
const references = [
    ...
    { city: 'Elazığ', country: 'Elazığ', description: 'Elazığ Entegre Sağlık Kampüsü', image: 'https://i.imgur.com/lGswA6W.jpeg' },
...
export default function Referanslar() {
    return (
        <div className="flex  flex-col  items-center justify-center  bg-slate-500 p-8">
